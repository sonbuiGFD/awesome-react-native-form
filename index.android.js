...
import { Form, InputComponent, CheckBox } from './customForm';
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        />
        {formData && formData.checkbox ? <Text> test text hiển thị check box</Text> : null}
      </Form>
        <TouchableHighlight
          style={{
            flex: 1,
